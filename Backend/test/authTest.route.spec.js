...
describe('Pruebas sobre la API de auth', () => {
    ...
    describe('Casos positivos de auth', () => {
        ...
        * Login de usuario
        */
        it('Login de usuario test', async() => {
        ...
        */
        it('Actualizar contraseña de usuario', async() => {
        ...
        */
        it('Renovar token de usuario', async() => {
        ...
        */
         it('Obtener usuario por nombre de usuario', async() => {
        ...
        */
        it('Eliminar usuario propio', async() => {
    ...
    describe('Casos negativos de auth', () => {
        ...
        it('Registro con correo duplicado' , async() => {
        ...
        it('Registro con nif duplicado' , async() => {
            await request( app ).post('/api/auth/register').send(newUser);
        ...
        it('Registro con telefono  duplicado' , async() => {
            await request( app ).post('/api/auth/register').send(newUser);
            let repetido = newUser;
            repetido.correo = "repetido@test.com";
        ...
        it('Registro con usuario  duplicado' , async() => {
            await request( app ).post('/api/auth/register').send(newUser);
            let repetido = newUser;
            repetido.correo = "repetido@test.com";
            repetido.nif = "70806873Q";
        ...
        it('Eliminar a otro usuario que no sea el suyo' , async() => {
            const response = await request( app ).delete('/api/auth/' + uid ).set('x-token', tokenIncorrecto);
     
            expect(response.status).toBe(401);
        });

        it('Eliminar a un usuario sin ser administrador' , async() => {
