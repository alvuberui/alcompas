  ...
  try {
    ...
    if (likeReq.tipo == "Noticia") {
      ...
      if (noticia.privacidad == "Privada") {
        ...
        const directivo = await Directivo.findOne({
          usuario: payloadId,
          banda: noticia.banda,
        });
        const archivero = await Archivero.findOne({
          usuario: payloadId,
          banda: noticia.banda,
        });
...
/*
 * Obtener like a una de las entidades válidas
 */
...
/*
 * Obtener numero de likes a una de las entidades válidas
 */
