...
const { crearRedSocial, getRedesByBandaId, eliminarRedSocial } = require('../controllers/redesSociales');
...
router.post('/',
    check('nombre', 'El título es obligatorio y como máximo debe tener 150 caracteres').isLength({min:1, max:150}),
    check('url', 'El texto debe contener entre 1 y 2000 caracteres').isLength({min:1, max:2000}),
