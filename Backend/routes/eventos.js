...
router.post(
  "/procesion",
  [
    check("titulo", "El título debe contener entre 1 y 50 caracteres").isLength(
      { min: 1, max: 50 }
    ),
    check(
      "descripcion",
      "La descripción debe de contener como máximo 2000 caracteres"
    ).isLength({ max: 2000 }),
    check("fechaInicio", "La fecha tiene que ser futura")
      .isISO8601()
      .toDate()
      .custom((value) => {
    ...
    check("fechaFin", "La fecha tiene que ser futura")
      .isISO8601()
      .toDate()
      .custom((value) => {
        const fecha = new Date(value);
    ...
    check(
      "comentarioEconomico",
      "El comentario económico debe de contener como máximo 2000 caracteres"
    ).isLength({ max: 1000 }),
    check(
      "localidad",
      "La localidad debe contener entre 1 y 20 caracteres"
    ).isLength({ min: 1, max: 20 }),
    check(
      "provincia",
      "La provincia debe contener entre 1 y 20 caracteres"
    ).isLength({ min: 1, max: 20 }),
    check("lugar", "El lugar debe contener entre 1 y 50 caracteres").isLength({
      min: 1,
      max: 50,
    }),
    check("costes", "Los costes deben ser un número").isNumeric(),
    check("beneficios", "Los beneficios deben ser un número").isNumeric(),
    check("dia", "El día no es válido")
      .not()
      .isEmpty()
      .custom((value) => {
    ...
    check("tipo", "El tipo debe ser un número")
      .not()
      .isEmpty()
      .custom((value) => {
    ...
    check("fechaSalida", "La fecha de salida es inválida")
      .isISO8601()
      .toDate()
      .custom((value) => {
        const fecha = new Date(value);
        if (fecha < new Date()) {
          throw new Error(
            "La fecha de salida no puede ser menor que la fecha actual"
          );
        }
        return true;
      }),
    check(
      "lugarSalida",
      "El lugar de salida debe contener entre 1 y 50 caracteres"
    ).isLength({ min: 1, max: 50 }),
    check("bocadillo", "El bocadillo debe ser un booleano").isBoolean(),
    check("hermandad", "La debe contener entre 1 y 50 caracteres").isLength({
      min: 1,
      max: 100,
    }),
    check(
      "nombreTitular",
      "El nombre del titular debe contener entre 1 y 50 caracteres"
    ).isLength({ min: 1, max: 50 }),
...
router.post(
  ...
  [
    ...
    check("costes", "Los costes deben ser un número").isNumeric(),
    check("beneficios", "Los beneficios deben ser un número").isNumeric(),
    check("tipoActuacion", "El tipo de actuación no es válido")
      .not()
      .isEmpty()
      .custom((value) => {
...
router.post(
  ...
  [
    ...
    check(
      "tematica",
      "La temática debe contener entre 1 y 200 caracteres"
