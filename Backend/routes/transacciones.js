...
router.post(
  "/",
  [
    check("tipo", "El tipo de transacción no es válido")
      .notEmpty()
      .custom((value) => {
    ...
    check(
      "motivo",
      "El motivo debe de contener entre 1 y 50 caracteres"
    ).isLength({ min: 1, max: 50 }),
    check(
      "descripcion",
      "La descripción debe contener como máximo 500 caracteres"
    ).isLength({ max: 500 }),
...
// Eliminar transacción por su id
