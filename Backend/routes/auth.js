...
router.post(
  ...
  [
    ...
    check(
      "contraseña",
      "La contraseña debe tener al meno 6 caracteres"
    ).isLength({ min: 6 }),
    validarCampos,
  ],
  loginUsuario
...
router.post(
  ...
  [
    check(
      "nombre",
      "El nombre debe de contener mínimo un caracter y máximo 150"
    )
      .notEmpty()
      .isLength({ min: 1, max: 150 }),
    check(
      "primer_apellido",
      "El primer apellido debe de contener mínimo un caracter y máximo 150"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 150 }),
    check(
      "segundo_apellido",
      "El segundo apellido debe de contener mínimo un caracter y máximo 150"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 150 }),
    check("fecha_nacimiento", "La fecha de nacimiento no es válida")
      .isISO8601()
      .toDate()
      .custom((value) => {
    ...
    check(
      "descripcion",
      "La descripción debe de contener mínimo un caracter y máximo 500"
    )
      .not()
      .isEmpty()
    ...
    check(
      "localidad",
      "La localidad debe de contener mínimo un caracter y máximo 50"
    )
      .not()
      .isEmpty()
    ...
    check(
      "provincia",
      "La provincia debe de contener mínimo un caracter y máximo 50"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 50 }),
    ...
    check(
      "direccion",
      "La dirección debe de contener mínimo un caracter y máximo 150"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 150 }),
    ...
    check(
      "usuario",
      "El usuario debe de contener mínimo un caracter y máximo 20"
    )
      .not()
      .isEmpty()
    ...
    check(
      "contraseña",
      "La contraseña debe de contener mínimo 7 caracteres y máximo 200"
    )
      .not()
      .isEmpty()
...
router.put(
  ...
  [
    ...
    check(
      "descripcion",
      "La descripción debe de contener mínimo un caracter y máximo 200"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 500 }),
    check(
      "localidad",
      "La localidad debe de contener mínimo un caracter y máximo 15"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 50 }),
    check(
      "provincia",
      "La provincia debe de contener mínimo un caracter y máximo 15"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 50 }),
    ...
    check(
      "direccion",
      "La dirección debe de contener mínimo un caracter y máximo 30"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 150 }),
    ...
    check(
      "usuario",
      "El usuario debe de contener mínimo un caracter y máximo 12"
    )
      .not()
      .isEmpty()
      .isLength({ min: 1, max: 20 }),
