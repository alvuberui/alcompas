    ...
    Swal.fire({
      ...
      .then(async (resultado) => {
        if (resultado.value) {
          ...
          setEventos((eventos) =>
            eventos.filter((not) => not._id !== noticiaDelete._id)
          );
        }
      })
      .then(() => {
  ...
  useEffect(() => {
    const isLoading = async () => {
      if (
        evento != undefined &&
        banda != undefined &&
        esDirectivo != undefined &&
        fotoPerfil != undefined &&
        isLiked != undefined &&
        numeroLikes != undefined &&
        pertenece != undefined &&
                ...
                action={
                  <>
                    {esDirectivo && (
                      <>
                        <NavLink
                          to={`/banda/panel/eventos/asistencia/${evento._id}/${tipoEvento}/`}
                        >
                        ...
                        <NavLink
                          to={`/banda/panel/eventos/editar/${tipoEvento}/${evento._id}`}
                        >
                          <IconButton aria-label="settings">
                            <EditIcon />
                          </IconButton>
                      ...
                      {esDirectivo && (
                        <>
                          ...
                          <Typography sx={{ display: "inline" }}>
                            {evento.comentarioEconomico
                              ? evento.comentarioEconomico
                              : "No hay ningún comentario económico..."}
                          </Typography>
                        </>
                      )}
                      {perteneceUsuarioBanda && (
