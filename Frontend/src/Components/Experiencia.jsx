        ...
        >
          <div>
            <Typography style={{ textAlign: "center" }}>
              {" "}
              <b>Fecha de inicio:</b> {experiencia.fecha_inicio}
            </Typography>
          </div>
          <div>
            <Typography style={{ textAlign: "center" }}>
              <b>Fecha final:</b> {experiencia.fecha_final}{" "}
            </Typography>
          </div>
          <div>
            {experiencia.cargo && (
          ...
          <div>
            {experiencia.instrumento && (
              <Typography style={{ textAlign: "center" }}>
                {" "}
                <b>Instrumento: </b> {experiencia.instrumento}
              </Typography>
            )}
          </div>
          <div>
          ...
          <div>
            {banda && (
              <Typography style={{ textAlign: "center" }}>
                {" "}
                <b>Banda: </b> {banda.tipo} {banda.nombre}
              </Typography>
            )}
          </div>
        </Grid>
