  ...
  const handleEliminarMusico = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        setComponentes(resp);
        Swal.fire("Eliminado", "El músico ha sido eliminado", "success");
      }
    });
  };
  ...
  const handleEliminarArchivero = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        setComponentes(resp);
        Swal.fire("Eliminado", "El archivero ha sido eliminado", "success");
      }
    });
  };
  ...
  const handleEliminarDirectivo = async (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire("Eliminado", "El directivo ha sido eliminado", "success");
      }
    });
  };
  ...
  const handleEliminarContratado = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const contratados = getContratadosByEnveto(
            ...
            {directivo && (
              ...
              >
                {tipo === "musico" ? (
                  ...
                  <IconButton
                    onClick={handleEliminarDirectivo}
                    sx={{ alignSelf: "flex-end" }}
                    color="error"
                    aria-label="upload picture"
                    component="label"
                  ...
                  <IconButton
                    onClick={handleEliminarArchivero}
                    sx={{ alignSelf: "flex-end" }}
                    color="error"
                    aria-label="upload picture"
                    component="label"
