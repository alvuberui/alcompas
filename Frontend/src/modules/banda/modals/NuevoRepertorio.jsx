...
export const NuevoRepertorio = ({ open, handleClose, setRepertorios, setOpen }) => {
    ...
    const handleForm = async e => {
        ...
        if(values.titulo.length > 50 || values.titulo < 1  ) error = error + " El nombre debe de contener emtre 1 y 50 caracteres";
        ...
        if(error != "") {
          Swal.fire('Error al añadir repertorio', error, 'error');
            ...
            if(res) {
                ...
                setOpen(false);
                Swal.fire('Repertorio añadido', 'El repertorio se ha añadido correctamente', 'success');
