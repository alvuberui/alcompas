...
export const NuevasRedSocial = ({ open, handleClose, setRedes, setOpen }) => {
  ...
  const handleForm = async (e) => {
    ...
    if (values.nombre.length > 150)
      error = error + " El nombre debe de contener menos de 150 caracteres";
    if (values.url.length > 2000 || values.url.length < 1)
      error =
        error + " <br>  La url debe de contener entre 1 y 2000 caracteres";
            ...
            <Grid container>
              <Grid item xs={12} sx={{ mt: 2 }}>
                ...
                >
                  ...
                  <MenuItem key={"TikTok"} value={"TikTok"}>
                    TikTok
                  </MenuItem>
                  <MenuItem key={"Spotify"} value={"Spotify"}>
                    Spotify
                  </MenuItem>
                  ...
                  <MenuItem key={"Apple Music"} value={"Apple Music"}>
                    Apple Music
                  </MenuItem>
