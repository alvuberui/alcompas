              ...
              <>
                ...
                <Grid item className="input-wrapper" xs={12} sx={{ mt: 3 }}>
                  ...
                  <DateTimePicker
                    id="datetime-picker"
                    onChange={(value) =>
                      setValues({ ...values, ["fechaSalida"]: value })
                    }
              ...
              <Grid item className="input-wrapper" xs={12} sx={{ mt: 3 }}>
                ...
                >
                  ...
                  >
                    ...
                    <MenuItem value={"Encuentro de Bandas"}>
                      Encuentro de Bandas
                    </MenuItem>
                    <MenuItem value={"Corrida de Toros"}>
                      Corrida de Toros
                    </MenuItem>
